...
@Validated
@Tag(name="Clientes V2", description = "Operaciones CRUD sobre Clientes con HATEOAS")
public class ClienteControllerV2 {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "El cliente ha sido creado.",
                    content = @Content(mediaType = MediaTypes.HAL_JSON_VALUE, schema = @Schema(implementation = Cliente.class))),
